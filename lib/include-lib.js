...
(function () {
    ...
    function load() {
        ...
        var libsConfig = {
            ...
            'mars3d-sm': [//三维地球“主库” 超图版本
                libpath + "cesiumjs/Cesium-supermap/Widgets/widgets.css", //超图版Cesium
                libpath + "cesiumjs/Cesium-supermap/Cesium.js",
                libpath + "cesiumjs/plugins/compatible/version.js", //cesium版本兼容处理

                libpath + "cesiumjs/mars3d/mars3d.css", //mars3d
                libpath + "cesiumjs/mars3d/mars3d.js",
                libpath + "cesiumjs/plugins/class/cesium-zh.js",
                "js/layer/S3MLayer.js",
                "js/layer/SMvtLayer.js",
            ],

        };

        //测试，使用本地的版本
        // libsConfig['mars3d-sm'] = [
        //     "lib/cesiumjs/Cesium-supermap/Widgets/widgets.css", //超图版Cesium
        //     "lib/cesiumjs/Cesium-supermap/Cesium.js",
        //     libpath + "cesiumjs/plugins/compatible/version.js", //cesium版本兼容处理
